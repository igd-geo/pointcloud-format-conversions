 ...
 */
fn write_uncompressed_blob<W: std::io::Write + std::io::Seek>(
    blob: &[u8],
    writer: &mut W,
...
fn write_uncompressed_block<W: std::io::Write + std::io::Seek>(
    point_buffer: &las_points::LasPoints,
    writer: &mut W,
) -> Result<u64> {
...
fn write_compressed_block<W: std::io::Write + std::io::Seek>(
    point_buffer: &las_points::LasPoints,
    writer: &mut W,
    compression_factor: u32,
) -> Result<u64> {
